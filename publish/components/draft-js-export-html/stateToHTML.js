...
var DATA_TO_ATTR = (_DATA_TO_ATTR = {}, _defineProperty(_DATA_TO_ATTR, _draftJsUtils.ENTITY_TYPE.LINK, function (entityType, entity) {
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)((0, _keys2.default)(data)), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  _createClass(MarkupGenerator, [{
    ...
    value: function writeEndTag(blockType) {
      ...
      if (tags.length === 1) {
        ...
        try {
          for (var _iterator4 = (0, _getIterator3.default)(tags), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    value: function renderBlockContent(block) {
      ...
      return entityPieces.map(function (_ref) {
        ...
        var content = stylePieces.map(function (_ref3) {
          ...
          try {
            for (var _iterator5 = (0, _getIterator3.default)(_this.styleOrder), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
function stringifyAttrs(attrs) {
  ...
  try {
    for (var _iterator6 = (0, _getIterator3.default)((0, _keys2.default)(attrs)), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
//# sourceMappingURL=stateToHTML.js.map
